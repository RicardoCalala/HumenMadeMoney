...
export interface Assessment { assessmentId: string; agreementId: string; versionId: string; documentDigest?: string; evidenceSetId: string; evidenceSetDigest?: string; evidenceCanonicalizationVersion?: "evidence-set-v1"; supersedesAssessmentId?: string; adapterKind: "deterministic" | "manual" | "model"; adapterVersion: string; providerClass?: "local_deterministic" | "development_model"; providerName?: string; modelVersion?: string; promptVersion?: string; schemaVersion?: string; claimReferenceContractVersion?: string; actionContractVersion?: string; policyVersion: string; status: "pending" | "completed" | "failed" | "superseded"; executionPhase?: "queued" | "in_progress"; criterionFindings: CriterionFinding[]; confidence: ConfidenceRepresentation; limitations: string[]; recommendedNextAction: "request_evidence" | "wait" | "request_human_review" | "participant_review" | "no_action"; authoritySafe?: boolean; semanticExpectationMatched?: "matched" | "mismatched" | "not_applicable"; acceptableActionMatched?: "matched" | "mismatched" | "not_applicable"; requestedByAccountId?: string; requestedByPartyId?: string; requestedByRole?: string; requestedAt?: string; completedAt?: string; fallbackReason?: string; fallbackFromProvider?: string; failureCode?: string; occurredAt: string; revision: number }
export interface AssessmentCapability { status: "eligible" | "eligible_with_gaps" | "unavailable"; reasonCodes: string[]; canRequest: boolean; providerClass: "local_deterministic"; providerLabel: "Local deterministic assessment"; budgetState: "available" | "paused" | "unavailable"; agreementId: string; versionId: string; acceptedAgreementVersion: number; documentDigest: string; evidenceSetDigest?: string; evidenceCanonicalizationVersion: "evidence-set-v1"; evidenceRevisionCount: number; activeAssessmentId?: string }
