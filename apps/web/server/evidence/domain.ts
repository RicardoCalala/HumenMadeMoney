...
export interface Assessment { assessmentId: string; agreementId: string; versionId: string; evidenceSetId: string; supersedesAssessmentId?: string; adapterKind: "deterministic" | "manual"; adapterVersion: string; policyVersion: string; status: "pending" | "completed" | "failed" | "superseded"; criterionFindings: CriterionFinding[]; confidence: ConfidenceRepresentation; limitations: string[]; recommendedNextAction: "request_evidence" | "wait" | "request_human_review" | "participant_review" | "no_action"; occurredAt: string; revision: number }
