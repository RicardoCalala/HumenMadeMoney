...
export type ProviderBlockedReason = "OPENAI_NOT_SELECTED" | "OPENAI_NOT_DEVELOPMENT" | "OPENAI_UI_DISABLED" | "OPENAI_FLAGS_DISABLED" | "OPENAI_KILL_SWITCH" | "OPENAI_KEY_ABSENT" | "OPENAI_CREDENTIAL_NOT_DEVELOPMENT" | "OPENAI_MODEL_NOT_SOLE_ALLOWLISTED" | "OPENAI_DATA_NOT_SYNTHETIC" | "OPENAI_CONFIGURATION_INVALID";
...
export class DevelopmentAssessmentProviderSelector {
  ...
  select(input: AssessmentAdapterInput): ProductProviderSelection {
    ...
    return { provider: new OpenAiAssessmentAdapter(this.transportFactory(), config), requestedProvider: "openai", config };
  }
}
