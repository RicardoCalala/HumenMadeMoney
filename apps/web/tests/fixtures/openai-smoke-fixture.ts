...
export const smokeFixtureId = "hmm-smoke-fixture-v1";
const document = {
...
export const smokeInput: AssessmentAdapterInput = {
  document, documentDigest: "synthetic-document-sha256-001", evidenceSetId: "evidence_set_smoke_001", evidenceSetDigest: "synthetic-evidence-set-sha256-001", evidenceCanonicalizationVersion: "evidence-set-v1",
